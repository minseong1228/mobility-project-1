...
int main() {
    ...
    cout << "Random Path Sampling shortest path length is : " << mcLen << "\n";
    cout << "Random Path Sampling path is : " << toDash(mc) << "\n";
    cout << "Dykstra algorithm path length is : " << djLen << "\n";
    cout << "Dykstra algorithm path is : " << toDash(dj) << "\n";
